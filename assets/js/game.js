...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) 
    {
        if (isPlayerTurn) {    
            ...
            // Player attacks!!!! remove enemy's health by subtracting the amount of 'playerInfo.attack' from 'enemy.health' & update new value of 'enemy.health'. 
